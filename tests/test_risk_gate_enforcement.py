...
class TestCanOpenPositionEnforcement:
    ...
    def test_buy_blocked_when_max_positions_reached(
        ...
        mock_risk_manager.can_open_position.return_value = RiskCheckResult(False, "Max open positions reached (3)")
    ...
    def test_buy_blocked_when_cooldown_active(
        ...
        mock_risk_manager.can_open_position.return_value = RiskCheckResult(False, "Cooldown period active")
    ...
    def test_buy_proceeds_when_all_limits_ok(
        ...
        mock_risk_manager.can_open_position.return_value = RiskCheckResult(True, "All checks passed")
    ...
    def test_sell_bypasses_can_open_position(
        ...
        mock_risk_manager.can_open_position.return_value = RiskCheckResult(False, "Daily loss limit reached")
    ...
    def test_state_machine_buy_blocked_by_risk(
        ...
        mock_risk_manager.can_open_position.return_value = RiskCheckResult(False, "Max daily trades reached (10)")
...
def test_risk_manager_blocks_new_entries_when_drawdown_limit_reached():
    ...
    def test_state_machine_sell_in_position_routes_to_managed_exit(
        ...
        bot._state_manager.get_state = Mock(
            return_value=TradeStateSnapshot(
                symbol="BTCUSDT",
...
def test_get_status_uses_total_balance_for_risk_summary_and_completed_trade_count():
    ...
    bot._get_portfolio_state = Mock(
        return_value={"balance": 677.39, "total_balance": 967.70, "timestamp": None, "positions": []}
    )
