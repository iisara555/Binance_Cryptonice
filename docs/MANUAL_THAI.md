...
├── cli_ui.py                        # Rich Terminal Dashboard
├── trading_bot.py                   # Orchestrator (ตัวควบคุมลูปหลัก)
├── trade_executor.py                # OMS - ระบบจัดการออเดอร์
├── signal_generator.py              # ตัวสร้างสัญญาณการเทรด
├── risk_management.py               # ตัวจัดการความเสี่ยง
├── bitkub_websocket.py              # Real-time WebSocket
├── database.py                      # SQLite (WAL-mode)
├── strategies/                      # Technical trading strategies
├── deploy/                          # Deployment scripts
│   ├── windows/                     # Windows NSSM service
│   └── systemd/                     # Linux systemd + tmux
...
Crypto_Sniper/
├── main.py                 # Entry point หลัก
├── trading_bot.py          # Orchestrator (3675 lines)
├── trade_executor.py       # OMS - Order Management System
├── signal_generator.py     # Signal generation engine
├── risk_management.py      # Risk calculations
├── state_management.py      # Trade state machine
├── api_client.py           # Bitkub API wrapper
├── bitkub_websocket.py     # Real-time price WebSocket
├── balance_monitor.py      # Balance event monitoring
├── cli_ui.py               # Rich terminal dashboard
├── monitoring.py           # Health checks & reconciliation
│
