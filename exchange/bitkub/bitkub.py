...
class Bitkub(Exchange):
    ...
    def fetch_order_book(
        self, pair: str, limit: int = 100, candle_type: str = "spot"
    ) -> dict[str, Any]:
        """
    ...
    def cancel_order(
        self, order_id: str | int, pair: str, side: str | None = None, **kwargs
    ) -> dict[str, Any]:
        """
        Cancel an order
        """
    ...
    def fetch_open_orders(
        self, pair: str | None = None, limit: int | None = None, **kwargs
    ) -> list[CcxtOrder]:
        """
