...
class BitkubRateLimiter:
    ...
    def __init__(self):
        self.public = TokenBucketRateLimiter(rate=self.PUBLIC_RATE, capacity=60, name="public")
        self.authenticated = TokenBucketRateLimiter(rate=self.AUTH_RATE, capacity=30, name="authenticated")
